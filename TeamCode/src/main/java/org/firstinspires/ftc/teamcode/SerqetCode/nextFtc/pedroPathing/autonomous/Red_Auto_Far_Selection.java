...
public class Red_Auto_Far_Selection extends SelectableOpMode {
    ...
    public Red_Auto_Far_Selection() {
        super("Select a Tuning OpMode", s -> {
            ...
            s.folder("Near Spike", n -> {
                n.add("1st Spike", Near_Red_1stSpike::new);
                n.add("2nd Spike", Near_Red_2ndSpike::new);
                n.add("3rd Spike", Near_Red_3rdSpike::new);
            });
        });
    }
    ...
    public static void drawOnlyCurrent() {
        try {
            Drawingss.drawRobot(follower.getPose());
            Drawingss.sendPacket();
        } catch (Exception e) {
